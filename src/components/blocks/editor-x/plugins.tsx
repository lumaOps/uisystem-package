...
import { callFunctionByName } from '@/utils/callers/caller';
...
export function Plugins({
  ...
  const [activeEditor1, setActiveEditor] = useState<unknown>();
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className=" top-0 z-10 flex flex-wrap gap-2 border-b p-1">
      ...
      <ActionsPlugin>
        <div className="clear-both flex flex-wrap items-center justify-between border-t p-1 overflow-auto gap-2">
          <div className="flex justify-start flex-1 gap-1">
            ...
            actions.every(item => typeof item === 'object' && item !== null) ? (
              <>
                  ...
                  return (
                    <CustomButton
                      ...
                      onClick={async () => {
                        ...
                        try {
                          setClicked(index);
                          await callFunctionByName(item.call || '', actionsParams, activeEditor1);
                        } catch (error: unknown) {
                          console.log(error);
                        }
                        setClicked(-1);
